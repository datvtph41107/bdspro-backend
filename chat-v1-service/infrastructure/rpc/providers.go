...
func NewBdsproRPCClient() (*clients.BdsproGrpcClient, func(), error) {
	return bindDependency("rpc.bdspro.address", clients.BindBdsproGrpcClient)
}

func NewCrmRPCClient() (*clients.CrmGrpcClient, func(), error) {
	return bindDependency("rpc.crm.address", clients.BindCrmGrpcClient)
}
