...
func (e ETargetHistory) IsValid() bool {
	switch e {
	case TargetHistoryLead,
		TargetHistoryContact,
		TargetHistoryPipeline,
		TargetHistoryStage,
		TargetHistoryRule,
		TargetHistoryProduct,
		TargetHistoryAsset,
		TargetHistoryCampaign,
		TargetHistoryPackage,
		TargetHistoryAdmin:
		return true
	default:
		return false
