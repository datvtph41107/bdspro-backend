...
type OrgCostTypeRouter struct {
	UC *shared_usecase.AssetCostTypeUsecase
}

func NewOrgCostTypeRouter(uc *shared_usecase.AssetCostTypeUsecase) *OrgCostTypeRouter {
	return &OrgCostTypeRouter{
		UC: uc,
	}
}

func (r *OrgCostTypeRouter) RegisterRoutes(router *gin.RouterGroup, path string) {
...
// @Security BearerAuth
// @Router /v1/bdspro/v2/org/assets/cost-type [get]
func (r *OrgCostTypeRouter) Search(c *gin.Context) {
	...
	result, total, err := r.UC.Search(c, enums.EOwnerOfOrganization, &dto)
...
// @Security BearerAuth
// @Router /v1/bdspro/v2/org/assets/cost-type/{id} [get]
func (r *OrgCostTypeRouter) GetByID(c *gin.Context) {
...
// @Security BearerAuth
// @Router /v1/bdspro/v2/org/assets/cost-type [post]
func (r *OrgCostTypeRouter) Create(c *gin.Context) {
...
// @Param body body domain.AssetCostType true "Body"
// @Security BearerAuth
// @Router /v1/bdspro/v2/org/assets/cost-type/{id} [put]
func (r *OrgCostTypeRouter) Update(c *gin.Context) {
	var dto domain.AssetCostType
	if err := _utils.ParseBodyWithValidator(c, &dto); err != nil {
		_routes.RouteResult(c, nil, _errors.ReturnError(_errors.RequestValidationFailed))
		return
...
// @Param id path int true "ID"
// @Security BearerAuth
// @Router /v1/bdspro/v2/org/assets/cost-type/{id} [delete]
func (r *OrgCostTypeRouter) Delete(c *gin.Context) {
	id, err := strconv.ParseUint(c.Param("id"), 10, 64)
	if err != nil {
		_routes.RouteResult(c, nil, _errors.ReturnError(_errors.RequestValidationFailed))
		return
