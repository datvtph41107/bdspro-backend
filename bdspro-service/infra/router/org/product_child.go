...
type OrgProductChildRouter struct {
	productService *shared_usecase.ProductUsecase
}

func NewOrgProductChildRouter(product *shared_usecase.ProductUsecase) *OrgProductChildRouter {
	return &OrgProductChildRouter{
		productService: product,
	}
}

func (route *OrgProductChildRouter) RegisterRoutes(r *gin.RouterGroup, path string) {
	api := r.Group(path)
	...
	// api.GET("/history/:id", route.History)
...
// // @Description API
// // @Tags Tổ chức: Sản phẩm
// // @Accept json
// // @Produce json
// // @Param productId path int false "Product ID"
// // @Security BearerAuth
// // @Param body body dto.SaveProductChildRequest true "Thông tin sản phẩm con"
// // @Router /v1/bdspro/v2/org/product/child/split [post]
// func (route *OrgProductChildRouter) CreateChild(c *gin.Context) {
...
// @Router /v1/bdspro/v2/org/product/child/merge [post]
func (route *OrgProductChildRouter) MergeChild(c *gin.Context) {
...
// @Security BearerAuth
// @Router /v1/bdspro/v2/org/product/child/merge-all/{productId} [post]
func (route *OrgProductChildRouter) MergeAll(c *gin.Context) {
...
// @Router /v1/bdspro/v2/org/product/child/devide [post]
func (route *OrgProductChildRouter) DevideChild(c *gin.Context) {
...
// // @Router /v1/bdspro/v2/org/product/child/history/:id [get]
// func (route *OrgProductChildRouter) History(c *gin.Context) {
// 	id, err := strconv.ParseUint(c.Param("id"), 10, 64)
// 	if err != nil {
// 		_routes.RouteResult(c, nil, &_routes.Except{
// 			Code:    400,
