...
func (v *DealMilestoneValidator) ValidateCreate(ctx context.Context, milestone *domain.DealMilestone) error {
	if milestone.Title == "" {
...
func (v *DealMilestoneValidator) ValidateUpdate(ctx context.Context, milestone *domain.DealMilestone) error {
	if milestone.ID == 0 {
