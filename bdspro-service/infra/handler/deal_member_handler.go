...
// 	"bdspro/infrastructure/client"
// 	"bdspro/infrastructure/transformer"
// 	"bdspro/infrastructure/validator"
...
// // @Accept json
// // @Produce json
// // @Param request body bdspropb.SendInvitationRequest true "Thông tin lời mời"
// // @Security BearerAuth
// // @Success 200 {object} bdspropb.SendInvitationResponse "Thành công"
// // @Router /deal-invitation [post]
// func (h *DealInvitationHandler) SendInvitation(ctx context.Context, req *bdspropb.SendDealInvitationRequest) (*bdspropb.SendDealInvitationResponse, error) {
...
// // @Accept json
// // @Produce json
// // @Param request body bdspropb.AcceptInvitationRequest true "Thông tin xác nhận"
// // @Security BearerAuth
// // @Success 200 {object} bdspropb.AcceptInvitationResponse "Thành công"
// // @Router /deal-invitation/accept [post]
// func (h *DealInvitationHandler) AcceptInvitation(ctx context.Context, req *bdspropb.AcceptDealInvitationRequest) (*bdspropb.AcceptDealInvitationResponse, error) {
...
// // @Accept json
// // @Produce json
// // @Param request body bdspropb.RejectInvitationRequest true "Thông tin từ chối"
// // @Security BearerAuth
// // @Success 200 {object} bdspropb.RejectInvitationResponse "Thành công"
// // @Router /deal-invitation/reject [post]
// func (h *DealInvitationHandler) RejectInvitation(ctx context.Context, req *bdspropb.RejectDealInvitationRequest) (*bdspropb.RejectDealInvitationResponse, error) {
...
// // @Accept json
// // @Produce json
// // @Param request body bdspropb.ResendInvitationRequest true "Thông tin gửi lại"
// // @Security BearerAuth
// // @Success 200 {object} bdspropb.ResendInvitationResponse "Thành công"
// // @Router /deal-invitation/resend [post]
// func (h *DealInvitationHandler) ResendInvitation(ctx context.Context, req *bdspropb.ResendDealInvitationRequest) (*bdspropb.ResendDealInvitationResponse, error) {
...
// // @Accept json
// // @Produce json
// // @Param request query bdspropb.SearchMembersRequest true "Thông tin tìm kiếm"
// // @Security BearerAuth
// // @Success 200 {object} bdspropb.SearchMembersResponse "Thành công"
...
// // @Security BearerAuth
// // @Success 200 {object} bdspropb.GetInvitationResponse "Thành công"
// // @Router /deal-invitation/{id} [get]
// func (h *DealInvitationHandler) GetInvitation(ctx context.Context, req *bdspropb.GetDealInvitationRequest) (*bdspropb.GetDealInvitationResponse, error) {
...
// // @Accept json
// // @Produce json
// // @Param request query bdspropb.GetInvitationsByDealRequest true "Thông tin lấy danh sách"
// // @Security BearerAuth
// // @Success 200 {object} bdspropb.GetInvitationsByDealResponse "Thành công"
// // @Router /deal/{deal_id}/invitations [get]
// func (h *DealInvitationHandler) GetInvitationsByDeal(ctx context.Context, req *bdspropb.GetDealInvitationsByDealRequest) (*bdspropb.GetDealInvitationsByDealResponse, error) {
