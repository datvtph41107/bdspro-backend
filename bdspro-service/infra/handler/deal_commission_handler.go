...
type DealCommissionHandler struct {
	bdspropb.UnimplementedDealCommissionServiceServer
	dealCommissionUsecase     usecases.DealCommissionUsecase
	dealCommissionTransformer mapper.DealCommissionTransformer
...
// @Param request body bdspropb.UpdateDealMemberCommissionRequest true "Thông tin hoa hồng"
// @Security BearerAuth
// @Success 200 {object} bdspropb.UpdateDealMemberCommissionResponse "Thành công"
// @Router /deal/{dealId}/member/{memberId}/commission [put]
func (h *DealCommissionHandler) UpdateDealMemberCommission(ctx context.Context, req *bdspropb.UpdateDealMemberCommissionRequest) (*bdspropb.UpdateDealMemberCommissionResponse, error) {
	// Validate request
...
// @Param dealId path uint64 true "ID thương vụ"
// @Param memberId path uint64 true "ID thành viên"
// @Param request body bdspropb.UpdateDealMemberNoteRequest true "Thông tin ghi chú"
// @Security BearerAuth
// @Success 200 {object} bdspropb.UpdateDealMemberNoteResponse "Thành công"
// @Router /deal/{dealId}/member/{memberId}/note [put]
func (h *DealCommissionHandler) UpdateDealMemberNote(ctx context.Context, req *bdspropb.UpdateDealMemberNoteRequest) (*bdspropb.UpdateDealMemberNoteResponse, error) {
	// Validate request
...
// @Produce json
// @Param dealId path uint64 true "ID thương vụ"
// @Param request body bdspropb.UpdateDealMembersCommissionRequest true "Thông tin hoa hồng cho nhiều members"
// @Security BearerAuth
// @Success 200 {object} bdspropb.UpdateDealMembersCommissionResponse "Thành công"
// @Router /deal/{dealId}/members/commission [put]
func (h *DealCommissionHandler) UpdateDealMembersCommission(ctx context.Context, req *bdspropb.UpdateDealMembersCommissionRequest) (*bdspropb.UpdateDealMembersCommissionResponse, error) {
	// Validate request
...
// @Param dealId path uint64 true "ID thương vụ"
// @Security BearerAuth
// @Success 200 {object} bdspropb.GetDealCommissionStatsResponse "Thành công"
// @Router /deal/{dealId}/commission/stats [get]
func (h *DealCommissionHandler) GetDealCommissionStats(ctx context.Context, req *bdspropb.GetDealCommissionStatsRequest) (*bdspropb.GetDealCommissionStatsResponse, error) {
	// Validate request
