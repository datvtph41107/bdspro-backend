...
type CreateDealTransactionRequest struct {
	...
	Type            enums.DealTransactionType `json:"type" validate:"required"`
	...
	TransactionType enums.DealTransactionType `json:"transaction_type"`
}
...
type GetDealTransactionsRequest struct {
	DealID uint64                     `json:"deal_id" validate:"required"`
	Type   *enums.DealTransactionType `json:"type"` // Optional filter
...
type DealTransactionResponse struct {
	...
	Type            enums.DealTransactionType `json:"type"`
